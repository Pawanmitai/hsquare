...
@section('body')
    ...
    <!--                        <img src="img/gallery/hsquare-banner-1.webp" alt="Image">-->
    <!--                    </a>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--            <div class="col-lg-12">-->
...
29 Golden Bay, a paragon of excellence that etches a grand impression.
The elite edifice that weighs the worth in gold is articulately designed to measure success in every parameter. Discover the treasure of boundless opportunities that walks you along the path of fortune, opulence and fame.</P>
<P>G+ 14-3 Level Basement Parking. 8 High-Speed Elevators, Shops / Retail Spaces on Ground Floor, Exclusive WorkSpaces / Offices</P>
                        ...
                        <h4 class="title-2 mb-10">Location Advantages</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="ltn__menu-widget">
                                        <ul>
                                            <li>
                                                <label class="checkbox-item">D-Mart-3 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">Belapur-2 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">Appollo Hospital-4 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">Proposed Navi Mumbai Airport-20 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="ltn__menu-widget">
                                        <ul>
                                            <li>
                                                <label class="checkbox-item">Croma Retail Store-2 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">NMMC Head Office-2 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">CBD Belapure Station-5 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">Sewri Nhava Sheva Sea Link-35-40 Mins
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                     ...
                     <h4 class="title-2">Floor Plans</h4>
                        ...
                        <div class="ltn__apartments-plan-area product-details-apartments-plan mb-60">
                            <div class="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center---">
                                <div class="nav">
                                    <a data-bs-toggle="tab" href="#liton_tab_3_1">Basement</a>
                                    <a class="active show"  data-bs-toggle="tab" href="#liton_tab_3_2" class="">Basement</a>
                                    <a data-bs-toggle="tab" href="#liton_tab_3_3" class="">Ground Floor</a>
                                    <a data-bs-toggle="tab" href="#liton_tab_3_4" class="">Typical Floor</a>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane fade" id="liton_tab_3_1">
                                    <div class="ltn__apartments-tab-content-inner">
                                        <div class="row">
                                            ...
                                            <!--        <h2>First Basement <br> Floor Plan</h2>-->
                                ...
                                <div class="tab-pane fade active show" id="liton_tab_3_2">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            ...
                                            <!--<div class="col-lg-8">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
                                            <!--        <h2>Second & Third <br> Basement  Floor Plan</h2>-->
                                ...
                                <div class="tab-pane fade" id="liton_tab_3_4">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            ...
                                            <!--<div class="col-lg-8">-->
                                            <!--  <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---" style="text-align:center;">-->
                                            <!-- <h4>Typical Floor Plan (Second to Thirteen Floor)</h4>-->
                        ...
                        <!--   <a href="img/gallery/golden-bay-5.jpg" data-rel="lightcase:myCollection">-->
                        <!--                <img class="mb-30" src="img/gallery/golden-bay-5.jpg" alt="Image">-->
                        <!--            </a>-->
                        <!--</div>-->
                        ...
                        <!--<div class="row">-->
                            ...
                            <!--                </ul>-->
                            <!--            </div>-->
                            <!--            <h2 class="product-title"><a href="unionetower.html">New Apartment Nice View</a></h2>-->
                            <!--            <div class="product-img-location">-->
                            <!--                <ul>-->
                            <!--                    <li>-->
                    ...
                    <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                        ...
                        <!--<div class="widget ltn__author-widget">-->
                            <!--<div class="ltn__author-widget-inner text-center">-->
                                <!--<img src="img/gallery/golden-bay-banner (2).jpg" alt="Image">-->
