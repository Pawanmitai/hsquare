            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                        ...
                        <div class="col-lg-12">
                          <img src="img/gallery/antalya-elevation.webp" alt="Image ">
                          </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="img/others/Antalyaelevation4.jpg" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                ...
                                <div class="tab-pane fade active show" id="liton_tab_3_2">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="img/others/Antalyaelevation3.jpg" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
                                ...
                                <div class="tab-pane fade" id="liton_tab_3_3">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="img/others/Antalyaelevation2.jpg" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
                                ...
                                <div class="tab-pane fade" id="liton_tab_3_4">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="img/others/Antalyaelevation6.jpg" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
