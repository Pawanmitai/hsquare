            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                        ...
                        <h1>Antalya Elevation</h1>
                        <label><span class="ltn__secondary-color"><i class="flaticon-pin"></i></span> CBD Belapur</label>
                        <div style="height:20px;"></div>
                        
                        <div class="col-lg-12">
                          <img src="{{ userAsset('img/gallery/antalya-elevation.webp')}}" alt="Image ">
                          </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="img/others/14.jpg" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{ userAsset('img/others/14.jpg')}}" alt="Image">
                                    </a>
                                    <a href="img/others/15.jpg" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{ userAsset('img/others/15.jpg')}}" alt="Image">
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <a href="img/others/16.jpg" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{ userAsset('img/others/16.jpg')}}" alt="Image">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="ltn__menu-widget">
                                        <ul>
                                            <li>
                                                <label class="checkbox-item">Kids Pool
                                            ...
                                            <li>
                                                <label class="checkbox-item">Open GYM
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">Kids Play Area
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                              ...
                                              <li>
                                                <label class="checkbox-item">Wifi POD
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="ltn__menu-widget">
                                        <ul>
                                            <li>
                                                <label class="checkbox-item">Yoga and Meditation Deck
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                             ...
                                             <li>
                                                <label class="checkbox-item">Sitout/ Plaza
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                               <li>
                                                <label class="checkbox-item">Party Lawn
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="checkbox-item">Live Chess
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            ...
                                            <li>
                                                <label class="checkbox-item">Accupressure Walkway
                                                    <input type="checkbox" checked="checked">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </li>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="{{ userAsset('img/others/Antalyaelevation4.jpg')}}" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                ...
                                <div class="tab-pane fade active show" id="liton_tab_3_2">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="{{ userAsset('img/others/Antalyaelevation3.jpg')}}" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
                                ...
                                <div class="tab-pane fade" id="liton_tab_3_3">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="{{ userAsset('img/others/Antalyaelevation2.jpg')}}" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
                                ...
                                <div class="tab-pane fade" id="liton_tab_3_4">
                                    <div class="ltn__product-tab-content-inner">
                                        <div class="row">
                                            <div class="col">
                                                <div class="apartments-plan-img">
                                                    <img src="{{ userAsset('img/others/Antalyaelevation6.jpg')}}" alt="#">
                                                </div>
                                            </div>
                                            <!--<div class="col-lg-5">-->
                                            <!--    <div class="apartments-plan-info ltn__secondary-bg--- text-color-white---">-->
                ...
                <div class="col-lg-4">
                    <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                        ...
                        <!--                    <a href="Antalya-Elevation.html"><img src="img/product/1.png" alt="#"></a>-->
                        <!--                </div>-->
                        ...
                        <!--                        </ul>-->
                        <!--                    </div>-->
                        <!--                    <h6><a href="Antalya-Elevation.html">Luxury House In Greenville </a></h6>-->
                        <!--                    <div class="product-price">-->
                        <!--                        <span>$30,000.00</span>-->
                        <!--                        <del>$35,000.00</del>-->
                        <!--                    </div>-->
                        ...
                        <!--            <div class="top-rated-product-item clearfix">-->
                        <!--                <div class="top-rated-product-img">-->
                        <!--                    <a href="Antalya-Elevation.html"><img src="img/product/2.png" alt="#"></a>-->
                        <!--                </div>-->
                        <!--                <div class="top-rated-product-info">-->
                        <!--                    <div class="product-ratting">-->
                        <!--                        <ul>-->
                        ...
                        <!--                        </ul>-->
                        <!--                    </div>-->
                        <!--                    <h6><a href="Antalya-Elevation.html">Apartment with Subunits</a></h6>-->
                        <!--                    <div class="product-price">-->
                        <!--                        <span>$30,000.00</span>-->
                        <!--                        <del>$35,000.00</del>-->
                        <!--                    </div>-->
                        ...
                        <!--                        </ul>-->
                        <!--                    </div>-->
                        <!--                    <h6><a href="Antalya-Elevation.html">3 Rooms Manhattan</a></h6>-->
                        <!--                    <div class="product-price">-->
                        <!--                        <span>$30,000.00</span>-->
                        <!--                        <del>$35,000.00</del>-->
                        <!--                    </div>-->
