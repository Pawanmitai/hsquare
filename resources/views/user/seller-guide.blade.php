                    ...
                    <div class="ltn__blog-list-wrap">
                        ...
                        <div class="ltn__blog-item ltn__blog-item-5">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ userAsset('img/blog/31.jpg')}}" alt="Image"></a>
                            </div>
                                    ...
                                    <div class="ltn__blog-meta">
                                        <ul>
                                            <li class="ltn__blog-author">
                                                <a href="#"><img src= "{{ userAsset('img/blog/author.jpg')}}" alt="#">By: Ethan</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="ltn__blog-item ltn__blog-item-5 ltn__blog-item-video">
                            <div class="ltn__video-img">
                                <img src= "{{ userAsset('img/blog/32.jpg')}}" alt="video popup bg image">
                        ...
                        <div class="ltn__blog-item ltn__blog-item-5 ltn__blog-item-gallery">
                            <div class="ltn__blog-gallery-active slick-arrow-1 slick-arrow-1-inner">
                                <div class="ltn__blog-gallery-item">
                                    <a href="blog-details.html"><img src="{{ userAsset('img/blog/33.jpg')}}" alt="Image"></a>
                                </div>
                                <div class="ltn__blog-gallery-item">
                                    <a href="blog-details.html"><img src="{{ userAsset('img/blog/34.jpg')}}" alt="Image"></a>
                                </div>
                                <div class="ltn__blog-gallery-item">
                                    <a href="blog-details.html"><img src="{{ userAsset('img/blog/31.jpg')}}" alt="Image"></a>
                                </div>
                        ...
                        <!-- Blog Item (Quote) -->
                        <div class="ltn__blog-item ltn__blog-item-5 ltn__blog-item-quote bg-image bg-overlay-theme-90" data-bs-bg="{{ userAsset('img/blog/3.jpg')}}">
                            <div class="ltn__blog-brief">
                                <blockquote>
                        ...
                        <div class="ltn__blog-item ltn__blog-item-5 ltn__blog-item-bg-image bg-image bg-overlay-white-90" data-bs-bg="{{ userAsset('img/blog/2.jpg')}}">
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-category">
                    ...
                    <aside class="sidebar-area blog-sidebar ltn__right-sidebar">
                        ...
                        <div class="widget ltn__author-widget">
                            <div class="ltn__author-widget-inner text-center">
                                <img src="{{ userAsset('img/team/4.jpg')}}" alt="Image">
                        ...
                        <div class="widget ltn__top-rated-product-widget">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{ userAsset('img/product/3.png')}}" alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                                                <ul>
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="{{ userAsset('img/product-3/6.jpg')}}" alt="#"></a>
                        ...
                        <div class="widget ltn__popular-post-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src= "{{ userAsset('img/team/5.jpg')}}" alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src= "{{ userAsset('img/team/6.jpg')}}" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src= "{{ userAsset('img/team/7.jpg')}}" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src= "{{ userAsset('img/team/8.jpg')}}" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                cing elit, sed do.</a></h6>
