            ...
            <div class="col-lg-8">
                <div class="ltn__blog-details-wrap">
                    <div class="ltn__page-details-inner ltn__blog-details-inner">
                        ...
                        <img src="{{ userAsset('img/blog/35.jpg')}}" alt="Image">
                        ...
                        <img class="alignleft" src="{{ userAsset('img/blog/blog-details/1.jpg')}}" alt="Image">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="{{ userAsset('img/service/31.jpg')}}" alt="Image">
                                <label>Image Caption Here</label>
                            </div>
                            <div class="col-lg-6">
                                <img src="{{ userAsset('img/service/32.jpg')}}" alt="Image">
                            </div>
                        </div>
                    ...
                    <div class="related-post-area mb-50">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="ltn__blog-item ltn__blog-item-6">
                                    <div class="ltn__blog-img">
                                        <a href="blog-details.html"><img src="{{ userAsset('img/blog/blog-details/11.jpg')}}" alt="Image"></a>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="ltn__blog-item ltn__blog-item-6">
                                    <div class="ltn__blog-img">
                                        <a href="blog-details.html"><img src="{{ userAsset('img/blog/blog-details/12.jpg')}}" alt="Image"></a>
                                    </div>
                                    <div class="ltn__blog-brief">
                                        <div class="ltn__blog-meta">
                                            <ul>
                        ...
                        <div class="ltn__comment-inner">
                            <ul>
                                <li>
                                    <div class="ltn__comment-item clearfix">
                                        <div class="ltn__commenter-img">
                                            <img src="{{ userAsset('img/testimonial/1.jpg')}}" alt="Image">
                                        </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="{{ userAsset('img/testimonial/3.jpg')}}" alt="Image">
                                                </div>
                                                <div class="ltn__commenter-comment">
                                                    <h6><a href="#">Adam Smit</a></h6>
                                ...
                                <li>
                                    <div class="ltn__comment-item clearfix">
                                        <div class="ltn__commenter-img">
                                            <img src="{{ userAsset('img/testimonial/4.jpg')}}" alt="Image">
                                        </div>
                                        <div class="ltn__commenter-comment">
                                            <h6><a href="#">Adam Smit</a></h6>
